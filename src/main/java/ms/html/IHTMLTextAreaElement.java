...
public interface IHTMLTextAreaElement extends Com4jObject {
  ...
  @DISPID(7005) //= 0x1b5d. The runtime will prefer the VTID if present
  @VTID(19)
  void select();
  ...
  @DISPID(7004) //= 0x1b5c. The runtime will prefer the VTID if present
  @VTID(24)
  void readOnly(
    boolean p);
  ...
  @DISPID(7001) //= 0x1b59. The runtime will prefer the VTID if present
  @VTID(26)
  void rows(
    int p);
  ...
  @DISPID(7002) //= 0x1b5a. The runtime will prefer the VTID if present
  @VTID(28)
  void cols(
    int p);
  ...
  @DISPID(7003) //= 0x1b5b. The runtime will prefer the VTID if present
  @VTID(30)
  void wrap(
    java.lang.String p);
  ...
  @DISPID(7006) //= 0x1b5e. The runtime will prefer the VTID if present
  @VTID(32)
