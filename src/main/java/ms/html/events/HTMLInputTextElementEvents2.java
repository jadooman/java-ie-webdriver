package ms.html.events;

import com4j.*;

@IID("{3050F618-98B5-11CF-BB82-00AA00BDCE0B}")
public abstract class HTMLInputTextElementEvents2 {
  // Methods:
  /**
   * @param pEvtObj Mandatory ms.html.IHTMLEventObj parameter.
   */

  @DISPID(-2147418102)
  public boolean onhelp(
    ms.html.IHTMLEventObj pEvtObj) {
