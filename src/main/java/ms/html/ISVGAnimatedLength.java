...
@IID("{305104D0-98B5-11CF-BB82-00AA00BDCE0B}")
public interface ISVGAnimatedLength extends Com4jObject {
  // Methods:
  /**
   * <p>
   * Setter method for the COM property "baseVal"
   * </p>
   * @param p Mandatory ms.html.ISVGLength parameter.
   */

  @DISPID(1000) //= 0x3e8. The runtime will prefer the VTID if present
  @VTID(7)
  void baseVal(
    ms.html.ISVGLength p);
