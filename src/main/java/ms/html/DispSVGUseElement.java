...
public interface DispSVGUseElement extends Com4jObject {
  // Methods:
  /**
   * <p>
  ...
  /**
   * <p>
   * Setter method for the COM property "instanceRoot"
   * </p>
   * @param rhs Mandatory ms.html.ISVGElementInstance parameter.
   */

  @DISPID(1059)
  @PropPut
  void instanceRoot(
    ms.html.ISVGElementInstance rhs);


  /**
   * <p>
   * Getter method for the COM property "instanceRoot"
   * </p>
   */

  @DISPID(1059)
  @PropGet
  ms.html.ISVGElementInstance instanceRoot();


  /**
   * <p>
   * Setter method for the COM property "animatedInstanceRoot"
   * </p>
   * @param rhs Mandatory ms.html.ISVGElementInstance parameter.
   */
  ...
  @DISPID(1060)
  @PropPut
  void animatedInstanceRoot(
    ms.html.ISVGElementInstance rhs);


  /**
   * <p>
   * Getter method for the COM property "animatedInstanceRoot"
   * </p>
   */

  @DISPID(1060)
  @PropGet
  ms.html.ISVGElementInstance animatedInstanceRoot();
