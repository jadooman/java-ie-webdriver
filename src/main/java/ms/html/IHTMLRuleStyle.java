...
@IID("{3050F3CF-98B5-11CF-BB82-00AA00BDCE0B}")
public interface IHTMLRuleStyle extends Com4jObject {
  // Methods:
  /**
   * <p>
  ...
  /**
   * <p>
   * Setter method for the COM property "textDecorationNone"
   * </p>
   * @param p Mandatory boolean parameter.
   */

  @DISPID(-2147413089) //= 0x8001139f. The runtime will prefer the VTID if present
  @VTID(43)
  void textDecorationNone(
    boolean p);


  /**
   * <p>
   * Getter method for the COM property "textDecorationNone"
   * </p>
  ...
  /**
   * <p>
   * Setter method for the COM property "textDecorationUnderline"
   * </p>
   * @param p Mandatory boolean parameter.
   */

  @DISPID(-2147413091) //= 0x8001139d. The runtime will prefer the VTID if present
  @VTID(45)
  ...
  /**
   * <p>
   * Getter method for the COM property "textDecorationUnderline"
   * </p>
   * @return  Returns a value of type boolean
   */
  ...
  /**
   * <p>
   * Setter method for the COM property "textDecorationOverline"
   * </p>
   * @param p Mandatory boolean parameter.
   */

  @DISPID(-2147413043) //= 0x800113cd. The runtime will prefer the VTID if present
  @VTID(47)
  void textDecorationOverline(
    boolean p);


  /**
   * <p>
   * Getter method for the COM property "textDecorationOverline"
   * </p>
   * @return  Returns a value of type boolean
   */
  ...
  /**
   * <p>
   * Setter method for the COM property "textDecorationLineThrough"
   * </p>
   * @param p Mandatory boolean parameter.
   */

  @DISPID(-2147413092) //= 0x8001139c. The runtime will prefer the VTID if present
  @VTID(49)
  void textDecorationLineThrough(
    boolean p);


  /**
   * <p>
   * Getter method for the COM property "textDecorationLineThrough"
   * </p>
   * @return  Returns a value of type boolean
   */
  ...
  /**
   * <p>
   * Setter method for the COM property "textDecorationBlink"
   * </p>
   * @param p Mandatory boolean parameter.
   */

  @DISPID(-2147413090) //= 0x8001139e. The runtime will prefer the VTID if present
  @VTID(51)
  void textDecorationBlink(
    boolean p);


  /**
   * <p>
   * Getter method for the COM property "textDecorationBlink"
   * </p>
   * @return  Returns a value of type boolean
   */
