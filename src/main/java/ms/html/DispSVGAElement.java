...
public interface DispSVGAElement extends Com4jObject {
  // Methods:
  /**
   * <p>
   * Setter method for the COM property "target"
   * </p>
   * @param rhs Mandatory ms.html.ISVGAnimatedString parameter.
   */

  @DISPID(1052)
  @PropPut
  void target(
    ms.html.ISVGAnimatedString rhs);
  ...
  @DISPID(1052)
  @PropGet
  ms.html.ISVGAnimatedString target();
